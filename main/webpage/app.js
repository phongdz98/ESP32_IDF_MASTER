...
/**
 * Sets the inerval for getting the updated DHT11 senser values.
 */

function startDHTSensorInterval() {
  setInterval(getDHT11SensorValues, 5000);
}

/**
 * Clears the connection status interval
 */
function stopWiFiConnectionStatusInterval() {
 ...
 */
function startWiFiConnectionStatusInterval() {
...
function connectWiFi() {
  ...
  startWiFiConnectionStatusInterval();
}
...
/**
 * Disconnect Wifi once the disconnect button is presses and reloads the web page.
 */
